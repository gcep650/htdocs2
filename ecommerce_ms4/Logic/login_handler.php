 ...
 * Synopsis: This module interprets user input and logs the user into the system if the information is correct.
...
if (no_blanks($username,$password)) {
    ...
    if ($result->num_rows == 1) {
        ...
        echo "<a href='../Presentation/login.html'><button>Back</button></a>";
    }
} else {
