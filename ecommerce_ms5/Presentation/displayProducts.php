...
for ($i = 0; $i < count($products); $i++) {
    ...
    echo "<tr><th>ID</th><th>Name</th><th>Description</th><th>Price</th><th>Quantity</th><th>Image</th><th>Add to Cart</th><th colspan=3>Actions</th></tr>";
    echo "<tr>";
    ...
    // print add to cart items
    echo "<td>";
    echo '<form action="../Logic/addToCart.php" method="post">';
    echo "<input type='hidden' id='product' name='product' value='" . $products[$i]['PRODUCT_ID'] . "'/>";
    echo "Quantity: <input type='number' name='quantity' id='quantity' min='1' style='width:45px;' /><br><input type='submit' value='Add to Cart'/>";
    echo "</form>";
    echo "</td>";
